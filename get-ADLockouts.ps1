function get-ADLockouts
{
    <#
.SYNOPSIS
    This function getss all Active Directory lockouts within in a number of days. The default is 1 day.

    .DESCRIPTION
    This function lists all Active Directory lockouts. The default search is one day.
...
get-ADLockoutsfunction get-ADLockouts
{
    <#
.SYNOPSIS
    This function getss all Active Directory lockouts within in a number of days. The default is 1 day.
